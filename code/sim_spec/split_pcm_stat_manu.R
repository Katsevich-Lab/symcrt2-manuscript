...
method_strings <- c(
  "split_pcm banded_precision bam_cs FALSE 0.3 25 FALSE bonferroni",
  "split_pcm banded_precision bam_cs FALSE 0.4 25 FALSE bonferroni",
  "split_pcm banded_precision bam_cs FALSE 0.5 25 FALSE bonferroni",
  "split_pcm banded_precision bam_cs FALSE 0.6 25 FALSE bonferroni",
  "split_pcm banded_precision bam_cs FALSE 0.7 25 FALSE bonferroni"
)
